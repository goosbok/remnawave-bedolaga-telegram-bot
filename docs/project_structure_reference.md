...
- `tests/database/test_user_has_used_trial.py` — Python-модуль
  Классы: нет
  Функции: `test_no_subs_both_trials_available`, `test_limited_trial_used_unlimited_still_available`, `test_unlimited_trial_used_limited_still_available`, `test_paid_subscription_blocks_both`, `test_paid_history_flag_blocks_both`, `test_pending_trial_ignored`, `test_is_trial_already_used_is_limited_wrapper`
