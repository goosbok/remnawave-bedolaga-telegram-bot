...
- `tests/services/test_monitoring_autopay_external.py` — Python-модуль
  Классы: нет
  Функции: `test_autopay_artemida_renews_vendor_not_panel`, `test_autopay_remnawave_uses_panel_update`
